...
import gurupurab from '../../assets/Image/Gurupurab Celebration.jpg'
const Gurupurabcelebration = () => {
    return (
        <>
            <section className="lg:pb-16 pb-10">
                <div className="container mx-auto px-5 lg:px-20">
                    <h2 className="lg:text-4xl md:text-3xl text-xl font-bold text-center text-[#1A237E]  lg:mb-10 mb-5">
                        Gurpurab <span className='text-[#ff6900]'>Celebrations</span>
                    </h2>
...
export default Gurupurabcelebration
